...
typedef enum {
	TM_SERVO_Clockwise = 0,
	TM_SERVO_AntiClockwise,
	TM_SERVO_Both
} TM_SERVO_Direction_t;
...
void SE_Servo_MotorStepsInDegrees(TM_SERVO_t* ServoStruct, float degrees, TM_SERVO_Direction_t dir);
